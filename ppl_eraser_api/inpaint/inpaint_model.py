...
from neuralgym.ops.gan_ops import gan_hinge_loss, random_interpolates
from neuralgym.ops.layers import flatten, resize
from neuralgym.ops.summary_ops import (gradients_summary, images_summary,
                                       scalar_summary)
from tensorflow.contrib.framework.python.ops import arg_scope

from .inpaint_ops import (bbox2mask, brush_stroke_mask, contextual_attention,
                          dis_conv, gen_conv, gen_deconv, local_patch,
                          random_bbox, resize_mask_like)
